...
if (usaInterfaz)
  ...
  if (usaInterfaz)
  {
    ...
    jjtn000.value = t.image;
        ...
        if(!gestorTSIntermedia.estaLexema(lexema))
        {
                ...
                System.out.println("TS-Intermedia: Insertando identificador: "+ lexema +" con alias " +a.getAlias());
        }
        else
        {
                System.err.println("TS-Intermedia: No se puede insertar el identificador: "+lexema);
        }
      label_13:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
 ...
 /*@bgen(jjtree) sentencia_for */
  ...
  if (usaInterfaz)
  {
    ...
    jjtc000 = false;
    jjtn000.jjtSetLastToken(getToken(0));
    System.out.println("simbolo2\u005ct" + sim2.codigo);
    sim.comienzo = nuevoBucle();
    sim.siguiente = finBucle();
    sim.codigo = sim1.codigo;
    sim.codigo += sim.comienzo + ":\u005cn";
